...
.setCustomId('form')
.setTitle('GallardoCraft - Destek Sistemi!')
...
const embed = new EmbedBuilder()
.setTitle("GallardoCraft - Kullanıcı Paneli!")
...
.setCustomId('form13')
.setTitle('GallardoCraft - Menülü Rol Alma Sistemi!')
...
value: "s2"
    ...
    const embed = new EmbedBuilder()
    .setTitle("GallardoCraft - Rol Alma Sistemi!")
...
client.on("interactionCreate", async (interaction, message) => {
  ...
  if(interaction.customId === "yardım") {
    ...
    let message = interaction.message.id
      ...
      .setTitle("GallardoCraft - Moderasyon Sistemi!")
    ...
    if (interaction.values[0] == "kullanıcı") { 
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("GallardoCraft - Kullanıcı Sistemi!")
  ...
  .setColor("#ff0000")
    ...
    if (interaction.values[0] == "giveaway") {
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("GallardoCraft - Çekiliş Sistemi!")
...
.setCustomId('formaq')
.setTitle('GallardoCraft - Başvuru Formu!')
